                ...
                <div className="flex flex-col md:flex-row h-full">
                    ...
                    <div className="p-8 md:w-3/5 flex flex-col justify-between">
                        ...
                        <div className="flex flex-wrap gap-3">
                             ...
                             <Link href="/Quiz/Analysis_1" className="px-5 py-2.5 border border-surface-light text-white text-sm font-bold rounded hover:bg-math-magenta/20 hover:border-math-magenta transition-all duration-300 ease-in-out flex items-center gap-2">
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                                QUIZ STARTEN
                             </Link>
                        </div>
